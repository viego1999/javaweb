...
public class EncryptionUtils {
    ...
    public static void main(String[] args) {
        System.out.println(getHash("吴新悦", "MD5"));
        System.out.println(getHash("吴新悦", "SHA") + "\n");

        System.out.println(getHash2("吴新悦", "MD5"));
        System.out.println(getHash2("吴新悦", "SHA") + "\n");

        System.out.println(getHash3("吴新悦", "MD5"));
        System.out.println(getHash3("吴新悦", "SHA") + "\n");
    }
